...
const storyMap = [
  { title: "第一周目 · 国外", body: "沈望在72小时内赶往海外城市 North Harbor（北港）的寄存中心，取回顾盼的旧电脑、郝倩的破损密信与艺术展合照；未兑现的2万美元本票则藏在旧电脑文件中。他从治疗订单、微信备份、远帆网站和隐藏索引中查明顾盼曾救助郝倩，也因此成为团伙目标。" },
  { title: "终于放手", body: "隐藏记录将顾盼标记为 HM-2217。郝倩害怕过去毁掉现在的生活。如果玩家选择停止要求她作证，沈望保留全部证据，决定用自己的方式惩罚伤害过顾盼的人。随后进入以旧合照和背向彼此的两人为固定背景、可滚动阅读完整文字的结局网页。" },
  ...
  { title: "方案变更", body: "刘涵在拘禁现场找到旧请柬与婚介合同残页。新郎邵明辉来自当地富豪家庭，原宴席已经取消。请柬二维码通向恒慕官网；合同抬头提供合同号，底部窄封边的摩斯码给出服务码 YQ-730419。" },
  { title: "真相与结局", body: "合同号、服务码和付款记录解锁“圆满方案”。刘涵通过浏览器进入临川公安档案查询网站，把匿名留言IP与公共网络节点一览交叉核验；取得死亡警情与遗体移交记录后，与恒慕特别委托组完成对质会进入第三结局《嫁》。顾盼旧电脑同时会恢复一封被删除的绝笔信，隐藏结局《镜花水月》只能从信末进入。" },
];
