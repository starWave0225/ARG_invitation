...
export default function YuanfanSite(){
  ...
  return <main className="route-page yuanfan-route"><div className="aid-public">
    ...
    <div className="aid-hero"><div><small>YUANFAN COMMUNITY SUPPORT</small><h2>异乡不必独行。</h2><p>由留学生发起的非营利互助网络，为新生提供接机、临时住宿、心理支持转介与同伴陪伴。</p><button onClick={()=>window.open("/yuanfan/contact","_blank","noopener,noreferrer")}>寻求帮助</button></div><div className="aid-photo"><span>远帆秋季迎新 · 2022</span></div></div>
    ...
    <section className={`aid-site-tools ${hasAccess?"unlocked":"locked"}`}>
      <div><small>MEMBER SITE ACCESS</small><h3>{hasAccess?"学生网站权限已开通":"此区域仅对已核验学生开放"}</h3><p>{hasAccess?"成员公告、活动日历与站内搜索已经启用。":"请通过远帆联络人完成学生身份核验。"}</p></div>
