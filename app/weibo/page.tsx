...
const posts:Post[]=[
  {id:1,date:"2021-09-03 08:16",year:"2021",place:"海外",plain:"开学第一周。",text:<>开学第一周。课很难，时差也很难，但有人每天在另一个半球陪我吃早餐。<br/>地图上先画一条线，总会有走到一起的地方。</>,tag:"留学生活",image:"map"},
  {id:2,date:"2021-12-19 23:41",year:"2021",place:"海外",plain:"在异国遇见本科同学。",text:<>在异国遇见本科同学，大概也算一种运气。她最近状态不太好，希望我没有多管闲事。</>,tag:"H.Q.",image:"snow"},
  {id:3,date:"2022-02-15 01:07",year:"2022",place:"海外",plain:"有些治疗名目写得很含糊。",text:<>有些治疗名目写得很含糊，好像只要换一个温和的词，痛苦就可以少一点。<br/>至少这一次，把人送到了安全的地方。</>,tag:"Harborwell",file:"receipt_HW-220214-HQ.jpg"},
  {id:4,date:"2022-10-26 19:22",year:"2022",place:"海外",plain:"明晚是学期结束聚会。",text:<>明晚是学期结束聚会。她说最近认识了一些新朋友，大家只是喝点东西、听音乐。<br/>她看起来终于好一点了。希望这次别再出什么岔子。</>,tag:"留学日常"},
...
export default function WeiboPage(){
  ...
  return <main className="wb-route gp-wb-dark">
    <header className="wb-top"><b><i>微</i>微博</b><div className="wb-search">⌕ <input value={query} onChange={e=>setQuery(e.target.value)} placeholder="搜她的微博"/></div><nav>首页　视频　发现　游戏</nav><span>沈望　⚙</span></header>
    <section className="wb-cover"><div className="wb-profile"><img src="/characters/gu-pan.png" alt="顾盼"/><h1>向阳处没有窗</h1><p>@GP_looking_right　♀</p><small>“暂停不是放弃。只是有些路，需要在没有人看见的时候慢慢走。”</small></div></section>
