...
export default function HaoQianWeibo(){
  return <main className="wb-route hq-wb">
    ...
    <div className="wb-layout hq-layout">
      <aside><section><h3>个人资料</h3><p>所在地：海外</p><p>教育信息：Northbridge University</p><p>感情状况：已婚</p></section><section className="hq-contact"><h3>其他账号</h3><p>微信：<b>hqian_17</b></p><small>“校友和熟人请备注姓名。”</small></section></aside>
