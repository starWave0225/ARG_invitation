...
export default function ShenWangWeibo(){
  return <main className="wb-route zw-wb">
    ...
    <section className="wb-cover zw-cover"><div className="wb-profile"><img src="/characters/shen-wang.png" alt="沈望"/><h1>左岸仍有灯</h1><p>@ZW_still_waiting　♂</p><small>软件工程师。偶尔拍照，常常忘记整理。</small></div></section>
    ...
    <div className="wb-layout">
      <aside><section><h3>个人资料</h3><p>所在地：临海</p><p>教育信息：临川理工大学</p><p>职业信息：互联网 / 软件工程师</p><p>简介：向左看，也向前走</p></section><section><h3>经常往来</h3><a className="wb-person-link" href="/weibo/lh" target="_blank" rel="noopener noreferrer"><img src="/characters/liu-han.png" alt="刘涵"/><span><b>涵哥不含糊</b><small>大学同学 · 查看主页 →</small></span></a></section></aside>
      <section className="wb-feed"><div className="wb-filter"><b>他的微博</b><span>按时间排序</span></div>{posts.map((post,index)=><article key={post.date}><img src="/characters/shen-wang.png" alt="沈望"/><div><header><b>左岸仍有灯</b><small>{post.date}　{post.note}</small></header><p>{post.text}</p>{index===3&&<div className="wb-attachment">旧照片 · IMG_20181021_ARTSHOW.jpg<small>图片因原图失效暂不可查看</small></div>}<footer><span>☆ 收藏</span><span>↗ 转发</span><span>□ 评论</span><span>♡ 赞</span></footer></div></article>)}</section>
      <aside className="wb-right"><section className="wb-people-card"><h3>可能认识的人</h3><a className="wb-person-link" href="/weibo/gupan" target="_blank" rel="noopener noreferrer"><img src="/characters/gu-pan.png" alt="顾盼"/><span><b>向阳处没有窗</b><small>共同关注 1 · 查看主页 →</small></span></a><CelebrityFollows shift={2} compact/></section><section><h3>账号近况</h3><p>该账号在2022年后很少更新，也从未公开提及分手对象的姓名。</p></section></aside>
    </div>
